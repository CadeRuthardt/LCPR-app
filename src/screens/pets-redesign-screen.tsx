...
function PetRow({ isLast, pet }: { isLast: boolean; pet: Pet }) {
  ...
  const vaccinationLabel = vaccinationStatus === "current" ? "Up to date" : vaccinationStatus === "expired" ? "Expired" : "Records needed";
  const vaccinationIcon = vaccinationStatus === "current" ? "check" : vaccinationStatus === "expired" ? "x" : "info";
  const vaccinationColor = vaccinationStatus === "current" ? colors.success : vaccinationStatus === "expired" ? colors.error : colors.warning;
