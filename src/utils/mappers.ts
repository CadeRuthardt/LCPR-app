...
export function mapGingrPetToPet(gingrPet: GingrPet): Pet {
  return {
    age: gingrPet.age,
    allergies: gingrPet.allergies,
    birthday: gingrPet.birthday,
    breed: `${gingrPet.species} | ${gingrPet.breed}`,
    colorAndMarkings: gingrPet.colorAndMarkings,
    careNote: gingrPet.vaccinationSummary,
    feedingMethod: gingrPet.feedingMethod,
    feedingNotes: gingrPet.feedingNotes,
    feedingSchedules: gingrPet.feedingSchedules,
    feedingType: gingrPet.feedingType,
    fixed: gingrPet.fixed,
    gender: gingrPet.gender,
    id: gingrPet.id,
    imageUrl: gingrPet.imageUrl ?? fallbackPetImage,
    immunizations: gingrPet.immunizations,
    medicationNotes: gingrPet.medicationNotes,
    medicationSchedules: gingrPet.medicationSchedules,
    medicines: gingrPet.medicines,
    name: gingrPet.name,
    nextImmunizationExpiration: gingrPet.nextImmunizationExpiration,
    notes: gingrPet.notes,
    rawData: gingrPet.rawData,
    source: "gingr",
    species: gingrPet.species,
    status: gingrPet.status === "Checked In" ? "Wellness" : "Active",
    vaccinationSummary: gingrPet.vaccinationSummary,
    vetName: gingrPet.vetName,
    vetPhone: gingrPet.vetPhone,
    vip: gingrPet.vip,
